package net.mehvahdjukaar.moonlight2.api.resources.textures;

import com.mojang.blaze3d.platform.NativeImage;
import net.mehvahdjukaar.moonlight2.api.util.math.colors.HSVColor;
import net.mehvahdjukaar.moonlight2.api.util.math.colors.RGBColor;
import net.mehvahdjukaar.moonlight2.api.util.math.kmeans.DataSet;
import net.mehvahdjukaar.moonlight2.api.util.math.kmeans.KMeans;
...
public final class SpriteUtils {
    ...
    public static NativeImage readImage(ResourceManager manager, ResourceLocation resourceLocation) throws IOException, NoSuchElementException {
        ...
        try (var r =  manager.getResource(resourceLocation)) {
            return NativeImage.read(r.getInputStream());
        } catch (Exception e) {
