...
import net.mehvahdjukaar.moonlight2.api.client.texture_renderer.FrameBufferBackedDynamicTexture;
import net.mehvahdjukaar.moonlight2.api.client.texture_renderer.RenderedTexturesManager;
import net.mehvahdjukaar.moonlight2.api.client.util.LOD;
import net.mehvahdjukaar.moonlight2.api.client.util.TextUtil;
import net.mehvahdjukaar.moonlight2.api.platform.ClientPlatformHelper;
import net.mehvahdjukaar.moonlight2.api.resources.textures.Palette;
import net.mehvahdjukaar.moonlight2.api.resources.textures.SpriteUtils;
import net.mehvahdjukaar.moonlight2.api.resources.textures.TextureImage;
import net.mehvahdjukaar.moonlight2.api.util.math.colors.BaseColor;
import net.mehvahdjukaar.moonlight2.api.util.math.colors.HCLColor;
import net.mehvahdjukaar.moonlight2.api.util.math.colors.RGBColor;
